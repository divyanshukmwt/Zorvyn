...
function Header({ onMenuClick, onAddTransaction }) {
  ...
  return (
    <header className="
      sticky top-0 z-40
      bg-surface-dark border-b border-white/[0.06]
      px-6 lg:px-8 py-4
    ...
    ">
      <div className="flex items-center gap-3 min-w-0">
        <button
          onClick={onMenuClick}
          className="lg:hidden flex-shrink-0 w-9 h-9 rounded-xl bg-white/[0.04] border border-white/[0.07] flex items-center justify-center text-slate-400 hover:text-slate-200 transition-colors"
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        <span className="
          ...
          px-3 py-1.5 rounded-badge text-xs font-semibold
        ...
        {role === 'admin' && (
          <button
            ...
            className="
              ...
              text-bg-dark text-sm font-semibold
